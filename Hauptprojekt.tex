...
Änderung der Schnittstelle kann zu Problemen bei den Clients führen; Besonders wenn viele vorhadnen sind; Verlust der Übersicht; ggf. keinen Plan welche Clients angepasst werden müssen; sowie ob noch alle MEthoden verwendet werden oder benötigt werden;
Viel Traffic bei MS im Netzwerk; Services müssen mit Fehlern und fehlenden Nachrichten klar kommen;
\section{Consumer Driven Contract Test}
Bei dem Ansatz Consumer-Driven Contracts werden die Schnittstellen bzw. die Verträge aus der Sicht des Clients/Consumers definiert. Dabei spielt es keine Rolle, ob es nur einen Cosumer oder mehrere existieren. Die jeweiligen Anfragen und gewünschten Antworten werden notiert und auf Grundlage dieser Informationen wird der Service implementiert. Dabei baut der Ansatz auf der Grundnahme auf, dass der Consumer am besten wüsste, was er nutzen möchte.
...
In der Ausführung von Toby Clemson über das Testen von Microservices wird dieses Verfahren explizit empfohlen. Dabei benennt er neben PACT noch zwei weitere Tools, welche Consumer Driven Contract Tests anbieten. Diese Tools sind PACTO und Janus. Für das Hauptprojekt wurde sich für PACT entschieden, da nach der ersten Recherche PACT den größten Umfang bietet und zumdem PACT besser dokumentiert ist, als die anderen Tools.
...
Beispiel raussuchen und anhand daran den Ablauf erläutern


\subsection{Vorteile Consumer Driven Contract Test}
Neben den generellen Vorteilen, welche man sich von dem Ansatz Consumer Driven Contract Test verpricht und schon im vorherigen Kapitel kurz skizziert wurden sind, gibt es noch weitere Vorteile, die sich explizit auf das Testen beziehen.



Erst die vermeintliche Vorteile benennen und dann den generellen Ablauf
...
\subsection{Consumer Driven Contract in MARS}
\begin{itemize}
